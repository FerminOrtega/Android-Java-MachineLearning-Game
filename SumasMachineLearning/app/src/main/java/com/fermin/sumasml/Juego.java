...
public class Juego extends AppCompatActivity {
    ...
    @BindView(R.id.btn_detect) Button detectar;
    ...
    CountDownTimer timer = new CountDownTimer(30000, 1000) {
        ...
        public void onFinish() {
            ...
            highscoretext.setText("Juego terminado!!!");
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            int cont = 0;
                            int operacionrandom = new Random().nextInt(4) + 1;
    ...
    public void showChangeLangDialog() {
        ...
        dialogBuilder.setNegativeButton("CANCELAR", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int whichButton) {
                Toast.makeText(context.getApplicationContext(), "Juego terminado", Toast.LENGTH_SHORT).show();
            }
        });
