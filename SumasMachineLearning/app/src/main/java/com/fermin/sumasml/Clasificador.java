...
public class Clasificador {
    private static final String LOG_TAG = Clasificador.class.getSimpleName();
    ...
    public Resultado classify(Bitmap bitmap) {
        ...
        return new Resultado(mResult, timeCost);
    }
